...
import { useApplyStoredThemeColors } from "@/lib/theme-colors";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practica escenas, interpreta personajes y deja que la IA TE ayude" },
      { name: "author", content: "Cine Estrella" },
      { property: "og:title", content: "Cine Estrella — Ensaya teatro con IA" },
      { property: "og:description", content: "Practica escenas, interpreta personajes y deja que la IA TE ayude" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Cine Estrella — Ensaya teatro con IA" },
      { name: "twitter:description", content: "Practica escenas, interpreta personajes y deja que la IA TE ayude" },
